...
#
# Generated by Vivado on Sun Aug 27 13:56:36 CEST 2023
...
# Script info
echo -e "PLL.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../SolarADC.gen/sources_1/ip/PLL/PLL_clk_wiz.v" \
    "$ref_dir/../../../../SolarADC.gen/sources_1/ip/PLL/PLL.v" \
  2>&1 | tee -a vlogan.log
