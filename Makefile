...
RTL_VLOG_SOURCES := $(RTL_DIR)/xadc.v $(RTL_DIR)/TickCounterRst.v $(RTL_DIR)/sp_optimizer.v $(RTL_DIR)/FSM.v $(RTL_DIR)/voltage_comparator.v $(RTL_DIR)/max_counter.v $(RTL_DIR)/horiz_counter.v $(RTL_DIR)/vert_counter.v $(RTL_DIR)/FF_Array.v $(RTL_DIR)/servo_driver.v $(RTL_DIR)/pwm_control.v $(RTL_DIR)/LCD.v $(RTL_DIR)/Debouncer.v
